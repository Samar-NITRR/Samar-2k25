    ...
    <>
      ...
      >
        <main className="w-[80%] h-full flex flex-row justify-between items-start">
          ...
          <div className="text-white w-[700px] h-[90%] md:h-[100%] flex flex-col justify-between items-center pt-16">
            <div>
              <div className="flex flex-row justify-center h-[5vmax] md:h-[4vmax] lg:h-[3vmax] items-center mb-1">
                ...
                <h1 className="font-knightWarrior text-[5vmax] md:text-[4vmax] lg:text-[3vmax] glow-text drop-shadow-[3px_3px_0px_#000] m-0">
                  2025
                </h1>
              </div>
              <h1 className="font-vermin text-9xl text-[#ff882d] glow-text m-0">
                <img
                  src={SamarIntroText}
                  alt="Samar Logo"
                  className="w-[90vw] md:h-[9vmax] lg:h-[9vmax] max-h-[100px]"
                />
              </h1>
            </div>

            <p className="max-w-[600px] font-fastLines bold text-2xl bold text-center tracking-widest drop-shadow-[2px_2px_0px_#000]">
