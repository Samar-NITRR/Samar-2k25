...
function Team() {
  return (
    <>
      <div className='w-full min-h-screen fixed' style={{ backgroundImage: `url(${bgImage})`, backgroundColor: 'black',}}> </div>
      <div id='team' className="w-full min-h-screen bg-cover bg-fixed bg-center text-white pt-[80px]" >
        {/* Section Heading */}
        <div className="text-center font-crossFly uppercase text-4xl font-extrabold py-10 w-full absolute mt-[10px]">
        ...
        {Object.keys(teamData).length > 0 ? (
          Object.keys(teamData).map((designation, index) => (
            <div key={index} className="py-10 mt-[120px]">
              {/* Designation Heading */}
